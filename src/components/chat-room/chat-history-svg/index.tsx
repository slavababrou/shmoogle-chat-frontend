...
interface ChatHistorySvgProps {
  size?: string;
}

export const ChatHistorySvg: FC<ChatHistorySvgProps> = memo(
  (props: ChatHistorySvgProps) => {
    const { size } = props;
    ...
    return (
      ...
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M12 6V12L16.23 14.94L14.97 16.49L10 13V6H12Z"
        ></path>
        <path
          fillRule="evenodd"
          clipRule="evenodd"
